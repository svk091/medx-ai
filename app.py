...
background_image_url = "https://www.altexsoft.com/static/blog-post-featured/2023/10/2e01c1f5-f3b0-4df5-bcd2-ab3bcbda970c.jpg"  # Replace with your image URL
...
if selected == "Lung Cancer Prediction":
    ...
    CHRONIC_DISEASE = st.number_input('Chronic Disease (1 = Yes; 0 = No)', min_value=0, max_value=1, help='Enter 1 for Yes or 0 for No')
